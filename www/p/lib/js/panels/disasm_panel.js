...
DisasmPanel.prototype.seek = function(addr) {
	...
	if (this.renaming !== null && this.rbox.value.length > 0) {
		if ($(this.selected).hasClass('insaddr')) {
			...
			if ($(this.selected).hasClass('fvar'))
				r2.cmd('afvn ' + r2ui._dis.renameOldValue + ' ' + r2ui._dis.rbox.value + ' @ ' + r2ui._dis.selected_offset, function() {});
			else if ($(this.selected).hasClass('farg'))
				r2.cmd('afan ' + r2ui._dis.renameOldValue + ' ' + r2ui._dis.rbox.value + ' @ ' + r2ui._dis.selected_offset, function() {});
		} else {
